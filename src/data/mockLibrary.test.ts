...
import { youtubeCatalog, spotifyCatalog, albums, albumTracks } from './mockLibrary';
...
describe('mockLibrary', () => {
  it('seeds a Midnight Ferry / Rosalind Ver duplicate on both streaming catalogs, for the duplicate-sheet demo', () => {
    expect(youtubeCatalog.some(t => t.title === 'Midnight Ferry' && t.artist === 'Rosalind Ver')).toBe(true);
